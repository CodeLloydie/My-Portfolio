<template>
  <footer class="border-t border-graphite-800 py-14 px-8">
    <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">

      <div>
        <p class="text-graphite-600 text-sm">{{ t('footer.name') }}</p>
      </div>
      ...
      <p class="text-graphite-700 text-sm tracking-widest">© {{ new Date().getFullYear() }}</p>
